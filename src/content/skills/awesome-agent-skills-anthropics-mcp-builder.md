...
description: "建立 MCP servers to integrate external APIs 與 services。"
category: "design"
tags:
...
license: "MIT"
originalName: "anthropics/mcp-builder"
originalDescription: "Create MCP servers to integrate external APIs and services"
activation: "當你需要建立 MCP servers to integrate external APIs 與 services時使用。"
useCases:
  - "需要建立 MCP servers to integrate external APIs 與 services。"
  - "想使用 anthropics/mcp-builder 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
建立 MCP servers to integrate external APIs 與 services。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `anthropics/mcp-builder`。
