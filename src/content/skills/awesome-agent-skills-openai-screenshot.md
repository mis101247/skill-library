...
description: "Capture desktop, app windows, 或 pixel regions across OS platforms。"
category: "agent"
tags:
...
license: "MIT"
originalName: "openai/screenshot"
originalDescription: "Capture desktop, app windows, or pixel regions across OS platforms"
activation: "當你需要Capture desktop, app windows, 或 pixel regions across OS platforms時使用。"
useCases:
  - "需要Capture desktop, app windows, 或 pixel regions across OS platforms。"
  - "想使用 openai/screenshot 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
Capture desktop, app windows, 或 pixel regions across OS platforms。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `openai/screenshot`。
