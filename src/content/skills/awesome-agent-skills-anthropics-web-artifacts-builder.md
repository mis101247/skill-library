...
description: "建置 complex claude.ai HTML artifacts 搭配 React 與 Tailwind。"
category: "design"
tags:
...
license: "MIT"
originalName: "anthropics/web-artifacts-builder"
originalDescription: "Build complex claude.ai HTML artifacts with React and Tailwind"
activation: "當你需要建置 complex claude.ai HTML artifacts 搭配 React 與 Tailwind時使用。"
useCases:
  - "需要建置 complex claude.ai HTML artifacts 搭配 React 與 Tailwind。"
  - "想使用 anthropics/web-artifacts-builder 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
建置 complex claude.ai HTML artifacts 搭配 React 與 Tailwind。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `anthropics/web-artifacts-builder`。
