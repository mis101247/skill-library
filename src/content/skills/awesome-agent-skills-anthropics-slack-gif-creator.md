---
title: "Slack GIF Creator Skill"
description: "建立 animated GIFs optimized 用於 Slack size constraints。"
category: "docs"
tags:
...
license: "MIT"
originalName: "anthropics/slack-gif-creator"
originalDescription: "Create animated GIFs optimized for Slack size constraints"
activation: "當你需要建立 animated GIFs optimized 用於 Slack size constraints時使用。"
useCases:
  - "需要建立 animated GIFs optimized 用於 Slack size constraints。"
  - "想使用 anthropics/slack-gif-creator 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
建立 animated GIFs optimized 用於 Slack size constraints。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `anthropics/slack-gif-creator`。
