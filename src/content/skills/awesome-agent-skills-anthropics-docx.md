...
license: "MIT"
originalName: "anthropics/docx"
originalDescription: "Create, edit, and analyze Word documents"
activation: "當你需要建立、編輯與分析 Word 檔案時使用。"
useCases:
  - "需要建立、編輯與分析 Word 檔案。"
  - "想使用 anthropics/docx 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
建立、編輯與分析 Word 檔案。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `anthropics/docx`。
