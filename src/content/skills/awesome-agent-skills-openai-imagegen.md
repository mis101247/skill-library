---
title: "Imagegen 設計 Skill"
description: "產生 and edit images 使用 OpenAI's Image API 用於 projects。"
category: "design"
tags:
...
license: "MIT"
originalName: "openai/imagegen"
originalDescription: "Generate and edit images using OpenAI's Image API for projects"
activation: "當你需要產生 and edit images 使用 OpenAI's Image API 用於 projects時使用。"
useCases:
  - "需要產生 and edit images 使用 OpenAI's Image API 用於 projects。"
  - "想使用 openai/imagegen 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
產生 and edit images 使用 OpenAI's Image API 用於 projects。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `openai/imagegen`。
