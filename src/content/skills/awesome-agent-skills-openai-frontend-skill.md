---
title: "前端 設計 Skill"
description: "建立 visually strong landing pages, websites, 與 app UIs 搭配 restrained composition。"
category: "design"
tags:
...
license: "MIT"
originalName: "openai/frontend-skill"
originalDescription: "Create visually strong landing pages, websites, and app UIs with restrained composition"
activation: "當你需要建立 visually strong landing pages, websites, 與 app UIs 搭配 restrained composition時使用。"
useCases:
  - "需要建立 visually strong landing pages, websites, 與 app UIs 搭配 restrained composition。"
  - "想使用 openai/frontend-skill 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
建立 visually strong landing pages, websites, 與 app UIs 搭配 restrained composition。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `openai/frontend-skill`。
