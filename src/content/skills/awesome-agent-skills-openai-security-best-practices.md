...
description: "Review code 用於 language-specific security vulnerabilities。"
category: "security"
tags:
...
license: "MIT"
originalName: "openai/security-best-practices"
originalDescription: "Review code for language-specific security vulnerabilities"
activation: "當你需要Review code 用於 language-specific security vulnerabilities時使用。"
useCases:
  - "需要Review code 用於 language-specific security vulnerabilities。"
  - "想使用 openai/security-best-practices 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
Review code 用於 language-specific security vulnerabilities。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `openai/security-best-practices`。
