...
description: "部署 apps to Cloudflare 使用 Workers, Pages, 與 platform services。"
category: "cloud"
tags:
...
license: "MIT"
originalName: "openai/cloudflare-deploy"
originalDescription: "Deploy apps to Cloudflare using Workers, Pages, and platform services"
activation: "當你需要部署 apps to Cloudflare 使用 Workers, Pages, 與 platform services時使用。"
useCases:
  - "需要部署 apps to Cloudflare 使用 Workers, Pages, 與 platform services。"
  - "想使用 openai/cloudflare-deploy 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
部署 apps to Cloudflare 使用 Workers, Pages, 與 platform services。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `openai/cloudflare-deploy`。
