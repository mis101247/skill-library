---
title: "SORA 設計 Skill"
description: "Generate, remix, 與 manage short video clips via OpenAI's Sora API。"
category: "design"
tags:
...
license: "MIT"
originalName: "openai/sora"
originalDescription: "Generate, remix, and manage short video clips via OpenAI's Sora API"
activation: "當你需要Generate, remix, 與 manage short video clips via OpenAI's Sora API時使用。"
useCases:
  - "需要Generate, remix, 與 manage short video clips via OpenAI's Sora API。"
  - "想使用 openai/sora 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
Generate, remix, 與 manage short video clips via OpenAI's Sora API。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `openai/sora`。
