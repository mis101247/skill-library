---
title: "Semgrep RULE Creator Skill"
description: "建立 and refine Semgrep rules 用於 vulnerability detection。"
category: "security"
tags:
...
license: "MIT"
originalName: "trailofbits/semgrep-rule-creator"
originalDescription: "Create and refine Semgrep rules for vulnerability detection"
activation: "當你需要建立 and refine Semgrep rules 用於 vulnerability detection時使用。"
useCases:
  - "需要建立 and refine Semgrep rules 用於 vulnerability detection。"
  - "想使用 trailofbits/semgrep-rule-creator 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
建立 and refine Semgrep rules 用於 vulnerability detection。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `trailofbits/semgrep-rule-creator`。
