...
description: "協助處理 Variant Analysis 相關工作，並依原始 Skill 說明完成設定與執行。"
category: "security"
tags:
...
license: "MIT"
originalName: "trailofbits/variant-analysis"
originalDescription: "Find similar vulnerabilities via pattern-based analysis"
activation: "當你需要協助處理 Variant Analysis 相關工作，並依原始 Skill 說明完成設定與執行時使用。"
useCases:
  - "需要協助處理 Variant Analysis 相關工作，並依原始 Skill 說明完成設定與執行。"
  - "想使用 trailofbits/variant-analysis 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
協助處理 Variant Analysis 相關工作，並依原始 Skill 說明完成設定與執行。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `trailofbits/variant-analysis`。
