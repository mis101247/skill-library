...
description: "建立 a new blank Figma file 或 FigJam file。"
category: "design"
tags:
...
license: "MIT"
originalName: "openai/figma-create-new-file"
originalDescription: "Create a new blank Figma file or FigJam file"
activation: "當你需要建立 a new blank Figma file 或 FigJam file時使用。"
useCases:
  - "需要建立 a new blank Figma file 或 FigJam file。"
  - "想使用 openai/figma-create-new-file 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
建立 a new blank Figma file 或 FigJam file。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `openai/figma-create-new-file`。
