...
description: "部署 applications 與 websites to Vercel 搭配 preview 或 production options。"
category: "cloud"
tags:
...
license: "MIT"
originalName: "openai/vercel-deploy"
originalDescription: "Deploy applications and websites to Vercel with preview or production options"
activation: "當你需要部署 applications 與 websites to Vercel 搭配 preview 或 production options時使用。"
useCases:
  - "需要部署 applications 與 websites to Vercel 搭配 preview 或 production options。"
  - "想使用 openai/vercel-deploy 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
部署 applications 與 websites to Vercel 搭配 preview 或 production options。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `openai/vercel-deploy`。
