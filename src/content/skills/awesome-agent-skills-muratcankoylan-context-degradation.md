---
title: "Context Degradation Skill"
description: "Recognize 模式 of context failure: lost-in-middle, poisoning, distraction, 與 clash。"
...
license: "MIT"
originalName: "muratcankoylan/context-degradation"
originalDescription: "Recognize patterns of context failure: lost-in-middle, poisoning, distraction, and clash"
activation: "當你需要Recognize 模式 of context failure: lost-in-middle, poisoning, distraction, 與 clash時使用。"
useCases:
  - "需要Recognize 模式 of context failure: lost-in-middle, poisoning, distraction, 與 clash。"
  - "想使用 muratcankoylan/context-degradation 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
Recognize 模式 of context failure: lost-in-middle, poisoning, distraction, 與 clash。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `muratcankoylan/context-degradation`。
