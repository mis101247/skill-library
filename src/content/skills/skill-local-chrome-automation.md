---
title: "Chrome 自動化 Skill"
description: "連線並控制 Google Chrome，透過 CDP 進行瀏覽器自動化與互動測試。"
category: "automation"
tags:
  - "skill-store"
  - "local-skill"
...
sourcePath: "skills/chrome-automation/chrome-automation/SKILL.md"
sourceUrl: "https://github.com/anbeime/skill/blob/main/skills/chrome-automation/chrome-automation/SKILL.md"
localPath: "software-engineering-prompt-repos/skill/skills/chrome-automation/chrome-automation/SKILL.md"
license: "CC-BY-4.0"
originalName: "chrome-automation"
originalDescription: "連線並控制 Google Chrome，透過 CDP 進行瀏覽器自動化與互動測試。"
activation: "當你需要 Chrome 自動化 的工作流程時使用。"
useCases:
  - "需要處理「連線並控制 Google Chrome，透過 CDP 進行瀏覽器自動化與互動測試」這類任務。"
  - "想直接閱讀或複製 chrome-automation 的完整 SKILL.md。"
...
連線並控制 Google Chrome，透過 CDP 進行瀏覽器自動化與互動測試。
