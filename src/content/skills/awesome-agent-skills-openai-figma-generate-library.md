...
description: "建置 or update a professional-grade design system in Figma from a codebase。"
category: "design"
tags:
...
license: "MIT"
originalName: "openai/figma-generate-library"
originalDescription: "Build or update a professional-grade design system in Figma from a codebase"
activation: "當你需要建置 or update a professional-grade design system in Figma from a codebase時使用。"
useCases:
  - "需要建置 or update a professional-grade design system in Figma from a codebase。"
  - "想使用 openai/figma-generate-library 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
建置 or update a professional-grade design system in Figma from a codebase。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `openai/figma-generate-library`。
