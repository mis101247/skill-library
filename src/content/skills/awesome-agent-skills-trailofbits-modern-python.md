---
title: "Modern Python 測試 Skill"
description: "Modern Python tooling 搭配 uv, ruff, ty, 與 pytest最佳實務。"
category: "testing"
tags:
...
license: "MIT"
originalName: "trailofbits/modern-python"
originalDescription: "Modern Python tooling with uv, ruff, ty, and pytest best practices"
activation: "當你需要Modern Python tooling 搭配 uv, ruff, ty, 與 pytest最佳實務時使用。"
useCases:
  - "需要Modern Python tooling 搭配 uv, ruff, ty, 與 pytest最佳實務。"
  - "想使用 trailofbits/modern-python 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
Modern Python tooling 搭配 uv, ruff, ty, 與 pytest最佳實務。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `trailofbits/modern-python`。
