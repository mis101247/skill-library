---
title: "Chatgpt APPS 設計 Skill"
description: "Build, scaffold, 與 troubleshoot ChatGPT Apps SDK apps 搭配 MCP server 與 widget UI。"
category: "design"
tags:
...
license: "MIT"
originalName: "openai/chatgpt-apps"
originalDescription: "Build, scaffold, and troubleshoot ChatGPT Apps SDK apps with MCP server and widget UI"
activation: "當你需要Build, scaffold, 與 troubleshoot ChatGPT Apps SDK apps 搭配 MCP server 與 widget UI時使用。"
useCases:
  - "需要Build, scaffold, 與 troubleshoot ChatGPT Apps SDK apps 搭配 MCP server 與 widget UI。"
  - "想使用 openai/chatgpt-apps 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
Build, scaffold, 與 troubleshoot ChatGPT Apps SDK apps 搭配 MCP server 與 widget UI。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `openai/chatgpt-apps`。
