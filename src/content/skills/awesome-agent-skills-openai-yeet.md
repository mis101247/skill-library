---
title: "YEET Skill"
description: "Stage, commit, push code, 與 open a GitHub pull request via CLI。"
category: "agent"
tags:
...
license: "MIT"
originalName: "openai/yeet"
originalDescription: "Stage, commit, push code, and open a GitHub pull request via CLI"
activation: "當你需要Stage, commit, push code, 與 open a GitHub pull request via CLI時使用。"
useCases:
  - "需要Stage, commit, push code, 與 open a GitHub pull request via CLI。"
  - "想使用 openai/yeet 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
Stage, commit, push code, 與 open a GitHub pull request via CLI。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `openai/yeet`。
