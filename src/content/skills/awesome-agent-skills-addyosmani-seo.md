---
title: "SEO Skill"
description: "Search engine optimization, crawlability, 與 structured data。"
category: "data"
tags:
...
license: "MIT"
originalName: "addyosmani/seo"
originalDescription: "Search engine optimization, crawlability, and structured data"
activation: "當你需要Search engine optimization, crawlability, 與 structured data時使用。"
useCases:
  - "需要Search engine optimization, crawlability, 與 structured data。"
  - "想使用 addyosmani/seo 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
Search engine optimization, crawlability, 與 structured data。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `addyosmani/seo`。
