...
description: "Json Canvas 相關 Agent Skill，協助處理「Create and edit JSON Canvas files (.canvas) with nodes, edges, groups, and connections. Use when working with .canvas files, creating visual canvases, mind maps, flowcharts, or when the user mentions Canvas files in Obsidian.」這類任務。"
category: "agent"
tags:
  - "skill-store"
  - "local-skill"
...
sourcePath: "skills/obsidian-skills-integrated/json-canvas/SKILL.md"
sourceUrl: "https://github.com/anbeime/skill/blob/main/skills/obsidian-skills-integrated/json-canvas/SKILL.md"
localPath: "software-engineering-prompt-repos/skill/skills/obsidian-skills-integrated/json-canvas/SKILL.md"
license: "CC-BY-4.0"
originalName: "json-canvas"
originalDescription: "Json Canvas 相關 Agent Skill，協助處理「Create and edit JSON Canvas files (.canvas) with nodes, edges, groups, and connections. Use when working with .canvas files, creating visual canvases, mind maps, flowcharts, or when the user mentions Canvas files in Obsidian.」這類任務。"
activation: "當你需要 Json Canvas 的工作流程時使用。"
useCases:
  - "需要處理「Json Canvas 相關 Agent Skill，協助處理「Create and edit JSON Canvas files (.canvas) with nodes, edges, groups, and connections. Use when working with .canvas files, creating visual canvases, mind maps, flowcharts, or when the user mentions Canvas files in Obsidian.」這類任務」這類任務。"
  - "想直接閱讀或複製 json-canvas 的完整 SKILL.md。"
...
files:
  - "skills/obsidian-skills-integrated/json-canvas/SKILL.md"
cautions:
...
Json Canvas 相關 Agent Skill，協助處理「Create and edit JSON Canvas files (.canvas) with nodes, edges, groups, and connections. Use when working with .canvas files, creating visual canvases, mind maps, flowcharts, or when the user mentions Canvas files in Obsidian.」這類任務。
