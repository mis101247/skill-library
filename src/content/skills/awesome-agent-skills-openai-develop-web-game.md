---
title: "Develop Web GAME 測試 Skill"
description: "建置 and test web games iteratively 使用 Playwright 搭配 time-stepping。"
category: "testing"
tags:
...
license: "MIT"
originalName: "openai/develop-web-game"
originalDescription: "Build and test web games iteratively using Playwright with time-stepping"
activation: "當你需要建置 and test web games iteratively 使用 Playwright 搭配 time-stepping時使用。"
useCases:
  - "需要建置 and test web games iteratively 使用 Playwright 搭配 time-stepping。"
  - "想使用 openai/develop-web-game 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
建置 and test web games iteratively 使用 Playwright 搭配 time-stepping。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `openai/develop-web-game`。
