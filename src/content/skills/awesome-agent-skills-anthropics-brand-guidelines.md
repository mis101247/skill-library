...
description: "Apply Anthropic's brand colors 與 typography to artifacts。"
category: "design"
tags:
...
license: "MIT"
originalName: "anthropics/brand-guidelines"
originalDescription: "Apply Anthropic's brand colors and typography to artifacts"
activation: "當你需要Apply Anthropic's brand colors 與 typography to artifacts時使用。"
useCases:
  - "需要Apply Anthropic's brand colors 與 typography to artifacts。"
  - "想使用 anthropics/brand-guidelines 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
Apply Anthropic's brand colors 與 typography to artifacts。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `anthropics/brand-guidelines`。
