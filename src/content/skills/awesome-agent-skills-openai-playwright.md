...
description: "Automate real browser interactions 用於 navigation, forms, 與 scraping。"
category: "testing"
tags:
...
license: "MIT"
originalName: "openai/playwright"
originalDescription: "Automate real browser interactions for navigation, forms, and scraping"
activation: "當你需要Automate real browser interactions 用於 navigation, forms, 與 scraping時使用。"
useCases:
  - "需要Automate real browser interactions 用於 navigation, forms, 與 scraping。"
  - "想使用 openai/playwright 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
Automate real browser interactions 用於 navigation, forms, 與 scraping。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `openai/playwright`。
