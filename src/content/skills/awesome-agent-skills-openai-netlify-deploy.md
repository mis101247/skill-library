---
title: "Netlify Deploy 身分驗證 Skill"
description: "Automate Netlify 部署s 搭配 CLI auth, linking, 與 environment support。"
category: "auth"
tags:
...
license: "MIT"
originalName: "openai/netlify-deploy"
originalDescription: "Automate Netlify deployments with CLI auth, linking, and environment support"
activation: "當你需要Automate Netlify 部署s 搭配 CLI auth, linking, 與 environment support時使用。"
useCases:
  - "需要Automate Netlify 部署s 搭配 CLI auth, linking, 與 environment support。"
  - "想使用 openai/netlify-deploy 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
Automate Netlify 部署s 搭配 CLI auth, linking, 與 environment support。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `openai/netlify-deploy`。
