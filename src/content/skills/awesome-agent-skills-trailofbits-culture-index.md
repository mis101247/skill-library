---
title: "Culture Index Skill"
description: "Index 與 search culture 檔案。"
category: "security"
tags:
...
license: "MIT"
originalName: "trailofbits/culture-index"
originalDescription: "Index and search culture documentation"
activation: "當你需要Index 與 search culture 檔案時使用。"
useCases:
  - "需要Index 與 search culture 檔案。"
  - "想使用 trailofbits/culture-index 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
Index 與 search culture 檔案。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `trailofbits/culture-index`。
