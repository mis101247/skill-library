---
title: "Linear Skill"
description: "Manage issues, projects, 與 team 工作流 in Linear。"
category: "agent"
tags:
...
license: "MIT"
originalName: "openai/linear"
originalDescription: "Manage issues, projects, and team workflows in Linear"
activation: "當你需要Manage issues, projects, 與 team 工作流 in Linear時使用。"
useCases:
  - "需要Manage issues, projects, 與 team 工作流 in Linear。"
  - "想使用 openai/linear 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
Manage issues, projects, 與 team 工作流 in Linear。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `openai/linear`。
