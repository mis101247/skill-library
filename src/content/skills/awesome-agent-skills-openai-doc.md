---
title: "DOC Skill"
description: "Read, create, 與 edit .docx 檔案 搭配 formatting 與 layout fidelity。"
category: "docs"
tags:
...
license: "MIT"
originalName: "openai/doc"
originalDescription: "Read, create, and edit .docx documents with formatting and layout fidelity"
activation: "當你需要Read, create, 與 edit .docx 檔案 搭配 formatting 與 layout fidelity時使用。"
useCases:
  - "需要Read, create, 與 edit .docx 檔案 搭配 formatting 與 layout fidelity。"
  - "想使用 openai/doc 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
Read, create, 與 edit .docx 檔案 搭配 formatting 與 layout fidelity。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `openai/doc`。
