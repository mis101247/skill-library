---
title: "Building Secure Contracts Skill"
description: "Smart contract security toolkit 搭配 vulnerability scanners 用於 6 blockchains。"
category: "security"
tags:
...
license: "MIT"
originalName: "trailofbits/building-secure-contracts"
originalDescription: "Smart contract security toolkit with vulnerability scanners for 6 blockchains"
activation: "當你需要Smart contract security toolkit 搭配 vulnerability scanners 用於 6 blockchains時使用。"
useCases:
  - "需要Smart contract security toolkit 搭配 vulnerability scanners 用於 6 blockchains。"
  - "想使用 trailofbits/building-secure-contracts 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
Smart contract security toolkit 搭配 vulnerability scanners 用於 6 blockchains。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `trailofbits/building-secure-contracts`。
