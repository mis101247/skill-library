---
title: "OpenAI DOCS 身分驗證 Skill"
description: "Provide authoritative guidance from OpenAI developer 檔案。"
category: "auth"
tags:
...
license: "MIT"
originalName: "openai/openai-docs"
originalDescription: "Provide authoritative guidance from OpenAI developer documentation"
activation: "當你需要Provide authoritative guidance from OpenAI developer 檔案時使用。"
useCases:
  - "需要Provide authoritative guidance from OpenAI developer 檔案。"
  - "想使用 openai/openai-docs 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
Provide authoritative guidance from OpenAI developer 檔案。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `openai/openai-docs`。
