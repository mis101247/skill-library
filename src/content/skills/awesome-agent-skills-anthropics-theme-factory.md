---
title: "Theme Factory 設計 Skill"
description: "Style artifacts 搭配 professional themes 或 generate custom themes。"
category: "design"
tags:
...
license: "MIT"
originalName: "anthropics/theme-factory"
originalDescription: "Style artifacts with professional themes or generate custom themes"
activation: "當你需要Style artifacts 搭配 professional themes 或 generate custom themes時使用。"
useCases:
  - "需要Style artifacts 搭配 professional themes 或 generate custom themes。"
  - "想使用 anthropics/theme-factory 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
Style artifacts 搭配 professional themes 或 generate custom themes。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `anthropics/theme-factory`。
