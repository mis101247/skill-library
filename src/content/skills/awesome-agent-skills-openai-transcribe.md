...
description: "Transcribe audio files to text 搭配 optional speaker diarization。"
category: "agent"
tags:
...
license: "MIT"
originalName: "openai/transcribe"
originalDescription: "Transcribe audio files to text with optional speaker diarization"
activation: "當你需要Transcribe audio files to text 搭配 optional speaker diarization時使用。"
useCases:
  - "需要Transcribe audio files to text 搭配 optional speaker diarization。"
  - "想使用 openai/transcribe 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
Transcribe audio files to text 搭配 optional speaker diarization。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `openai/transcribe`。
