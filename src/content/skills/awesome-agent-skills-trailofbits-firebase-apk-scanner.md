---
title: "Firebase APK Scanner 雲端部署 Skill"
description: "Scan Android APKs 用於 Firebase misconfigurations 與 security vulnerabilities。"
category: "cloud"
tags:
...
license: "MIT"
originalName: "trailofbits/firebase-apk-scanner"
originalDescription: "Scan Android APKs for Firebase misconfigurations and security vulnerabilities"
activation: "當你需要Scan Android APKs 用於 Firebase misconfigurations 與 security vulnerabilities時使用。"
useCases:
  - "需要Scan Android APKs 用於 Firebase misconfigurations 與 security vulnerabilities。"
  - "想使用 trailofbits/firebase-apk-scanner 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
Scan Android APKs 用於 Firebase misconfigurations 與 security vulnerabilities。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `trailofbits/firebase-apk-scanner`。
