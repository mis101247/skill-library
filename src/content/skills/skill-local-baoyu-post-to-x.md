---
title: "Baoyu Post To X Skill"
description: "把短文、圖片、影片或長文發布到 X / Twitter。"
category: "content"
tags:
  - "skill-store"
  - "local-skill"
...
sourcePath: "skills/content-creation-publisher/baoyu-post-to-x/SKILL.md"
sourceUrl: "https://github.com/anbeime/skill/blob/main/skills/content-creation-publisher/baoyu-post-to-x/SKILL.md"
localPath: "software-engineering-prompt-repos/skill/skills/content-creation-publisher/baoyu-post-to-x/SKILL.md"
license: "CC-BY-4.0"
originalName: "baoyu-post-to-x"
originalDescription: "把短文、圖片、影片或長文發布到 X / Twitter。"
activation: "當你需要 Baoyu Post To X 的工作流程時使用。"
useCases:
  - "需要處理「把短文、圖片、影片或長文發布到 X / Twitter」這類任務。"
  - "想直接閱讀或複製 baoyu-post-to-x 的完整 SKILL.md。"
...
files:
  - "skills/content-creation-publisher/baoyu-post-to-x/SKILL.md"
cautions:
