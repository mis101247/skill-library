...
description: "Detect insecure default configurations like hardcoded secrets, default credentials, 與 weak crypto。"
category: "security"
tags:
...
license: "MIT"
originalName: "trailofbits/insecure-defaults"
originalDescription: "Detect insecure default configurations like hardcoded secrets, default credentials, and weak crypto"
activation: "當你需要Detect insecure default configurations like hardcoded secrets, default credentials, 與 weak crypto時使用。"
useCases:
  - "需要Detect insecure default configurations like hardcoded secrets, default credentials, 與 weak crypto。"
  - "想使用 trailofbits/insecure-defaults 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
Detect insecure default configurations like hardcoded secrets, default credentials, 與 weak crypto。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `trailofbits/insecure-defaults`。
