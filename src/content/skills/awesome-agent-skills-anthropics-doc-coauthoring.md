---
title: "DOC Coauthoring Skill"
description: "Collaborative document editing 與 co-authoring。"
category: "auth"
tags:
...
license: "MIT"
originalName: "anthropics/doc-coauthoring"
originalDescription: "Collaborative document editing and co-authoring"
activation: "當你需要Collaborative document editing 與 co-authoring時使用。"
useCases:
  - "需要Collaborative document editing 與 co-authoring。"
  - "想使用 anthropics/doc-coauthoring 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
Collaborative document editing 與 co-authoring。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `anthropics/doc-coauthoring`。
