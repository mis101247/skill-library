...
description: "Widely used prompt engineering techniques 與 模式, including Anthropic 最佳實務 與 agent persuasion principles。"
category: "agent"
tags:
...
license: "MIT"
originalName: "NeoLabHQ/prompt-engineering"
originalDescription: "Widely used prompt engineering techniques and patterns, including Anthropic best practices and agent persuasion principles."
activation: "當你需要Widely used prompt engineering techniques 與 模式, including Anthropic 最佳實務 與 agent persuasion principles時使用。"
useCases:
  - "需要Widely used prompt engineering techniques 與 模式, including Anthropic 最佳實務 與 agent persuasion principles。"
  - "想使用 NeoLabHQ/prompt-engineering 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
Widely used prompt engineering techniques 與 模式, including Anthropic 最佳實務 與 agent persuasion principles。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `NeoLabHQ/prompt-engineering`。
