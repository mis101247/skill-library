---
title: "Aspnet CORE 設計 Skill"
description: "Build, review, 與 architect ASP.NET Core apps (Blazor, MVC, Minimal APIs, etc.)。"
category: "design"
tags:
...
license: "MIT"
originalName: "openai/aspnet-core"
originalDescription: "Build, review, and architect ASP.NET Core apps (Blazor, MVC, Minimal APIs, etc.)"
activation: "當你需要Build, review, 與 architect ASP.NET Core apps (Blazor, MVC, Minimal APIs, etc.)時使用。"
useCases:
  - "需要Build, review, 與 architect ASP.NET Core apps (Blazor, MVC, Minimal APIs, etc.)。"
  - "想使用 openai/aspnet-core 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
Build, review, 與 architect ASP.NET Core apps (Blazor, MVC, Minimal APIs, etc.)。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `openai/aspnet-core`。
