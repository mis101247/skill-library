---
title: "PowerPoint 簡報 Skill"
description: "建立、編輯與分析 PowerPoint 簡報。"
category: "docs"
tags:
...
license: "MIT"
originalName: "anthropics/pptx"
originalDescription: "Create, edit, and analyze PowerPoint presentations"
activation: "當你需要建立、編輯與分析 PowerPoint 簡報時使用。"
useCases:
  - "需要建立、編輯與分析 PowerPoint 簡報。"
  - "想使用 anthropics/pptx 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
建立、編輯與分析 PowerPoint 簡報。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `anthropics/pptx`。
