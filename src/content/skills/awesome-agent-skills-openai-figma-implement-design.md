...
description: "Translate Figma designs into production-ready code 搭配 1:1 visual fidelity。"
category: "design"
tags:
...
license: "MIT"
originalName: "openai/figma-implement-design"
originalDescription: "Translate Figma designs into production-ready code with 1:1 visual fidelity"
activation: "當你需要Translate Figma designs into production-ready code 搭配 1:1 visual fidelity時使用。"
useCases:
  - "需要Translate Figma designs into production-ready code 搭配 1:1 visual fidelity。"
  - "想使用 openai/figma-implement-design 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
Translate Figma designs into production-ready code 搭配 1:1 visual fidelity。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `openai/figma-implement-design`。
