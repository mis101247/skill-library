---
title: "Notion SPEC TO Implementation Skill"
description: "Convert Notion specs into linked implementation plans 與 tasks。"
category: "docs"
tags:
...
license: "MIT"
originalName: "openai/notion-spec-to-implementation"
originalDescription: "Convert Notion specs into linked implementation plans and tasks"
activation: "當你需要Convert Notion specs into linked implementation plans 與 tasks時使用。"
useCases:
  - "需要Convert Notion specs into linked implementation plans 與 tasks。"
  - "想使用 openai/notion-spec-to-implementation 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
Convert Notion specs into linked implementation plans 與 tasks。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `openai/notion-spec-to-implementation`。
