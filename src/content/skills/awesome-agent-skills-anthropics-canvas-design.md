...
description: "設計 visual art in PNG 與 PDF formats。"
category: "design"
tags:
...
license: "MIT"
originalName: "anthropics/canvas-design"
originalDescription: "Design visual art in PNG and PDF formats"
activation: "當你需要設計 visual art in PNG 與 PDF formats時使用。"
useCases:
  - "需要設計 visual art in PNG 與 PDF formats。"
  - "想使用 anthropics/canvas-design 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
設計 visual art in PNG 與 PDF formats。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `anthropics/canvas-design`。
