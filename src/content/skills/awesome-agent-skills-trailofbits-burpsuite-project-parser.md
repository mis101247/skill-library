---
title: "Burpsuite Project Parser Skill"
description: "Search 與 extract data from Burp Suite project files。"
category: "security"
tags:
...
license: "MIT"
originalName: "trailofbits/burpsuite-project-parser"
originalDescription: "Search and extract data from Burp Suite project files"
activation: "當你需要Search 與 extract data from Burp Suite project files時使用。"
useCases:
  - "需要Search 與 extract data from Burp Suite project files。"
  - "想使用 trailofbits/burpsuite-project-parser 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
Search 與 extract data from Burp Suite project files。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `trailofbits/burpsuite-project-parser`。
