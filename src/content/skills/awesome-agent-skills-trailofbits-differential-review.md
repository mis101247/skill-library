...
description: "Security-focused diff review 搭配 git history analysis。"
category: "security"
tags:
...
license: "MIT"
originalName: "trailofbits/differential-review"
originalDescription: "Security-focused diff review with git history analysis"
activation: "當你需要Security-focused diff review 搭配 git history analysis時使用。"
useCases:
  - "需要Security-focused diff review 搭配 git history analysis。"
  - "想使用 trailofbits/differential-review 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
Security-focused diff review 搭配 git history analysis。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `trailofbits/differential-review`。
