...
description: "建立 generative art 使用 p5.js 搭配 seeded randomness。"
category: "agent"
tags:
...
license: "MIT"
originalName: "anthropics/algorithmic-art"
originalDescription: "Create generative art using p5.js with seeded randomness"
activation: "當你需要建立 generative art 使用 p5.js 搭配 seeded randomness時使用。"
useCases:
  - "需要建立 generative art 使用 p5.js 搭配 seeded randomness。"
  - "想使用 anthropics/algorithmic-art 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
建立 generative art 使用 p5.js 搭配 seeded randomness。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `anthropics/algorithmic-art`。
