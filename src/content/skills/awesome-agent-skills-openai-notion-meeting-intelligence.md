---
title: "Notion Meeting Intelligence Skill"
description: "Prep meetings by pulling Notion context 與 tailoring agendas。"
category: "docs"
tags:
...
license: "MIT"
originalName: "openai/notion-meeting-intelligence"
originalDescription: "Prep meetings by pulling Notion context and tailoring agendas"
activation: "當你需要Prep meetings by pulling Notion context 與 tailoring agendas時使用。"
useCases:
  - "需要Prep meetings by pulling Notion context 與 tailoring agendas。"
  - "想使用 openai/notion-meeting-intelligence 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
Prep meetings by pulling Notion context 與 tailoring agendas。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `openai/notion-meeting-intelligence`。
