---
title: "Memory Systems 設計 Skill"
description: "設計 short-term, long-term, 與 graph-based memory architectures。"
category: "design"
tags:
...
license: "MIT"
originalName: "muratcankoylan/memory-systems"
originalDescription: "Design short-term, long-term, and graph-based memory architectures"
activation: "當你需要設計 short-term, long-term, 與 graph-based memory architectures時使用。"
useCases:
  - "需要設計 short-term, long-term, 與 graph-based memory architectures。"
  - "想使用 muratcankoylan/memory-systems 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
設計 short-term, long-term, 與 graph-based memory architectures。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `muratcankoylan/memory-systems`。
