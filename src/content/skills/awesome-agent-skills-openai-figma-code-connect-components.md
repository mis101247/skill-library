...
license: "MIT"
originalName: "openai/figma-code-connect-components"
...
useCases:
  ...
  - "想使用 openai/figma-code-connect-components 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
串接 Figma design 元件 to code 元件 使用 Code Connect。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `openai/figma-code-connect-components`。
