---
title: "內容研究寫作 Skill"
description: "協助撰寫高品質內容，會先做研究、補引用、改善開場，並透過多輪修改讓文章更完整。"
...
sourcePath: "skills/content-research-writer/SKILL.md"
sourceUrl: "https://github.com/anbeime/skill/blob/main/skills/content-research-writer/SKILL.md"
localPath: "software-engineering-prompt-repos/skill/skills/content-research-writer/SKILL.md"
license: "CC-BY-4.0"
originalName: "content-research-writer"
originalDescription: "協助撰寫高品質內容，會先做研究、補引用、改善開場，並透過多輪修改讓文章更完整。"
activation: "當你需要 內容研究寫作 的工作流程時使用。"
useCases:
  - "需要處理「協助撰寫高品質內容，會先做研究、補引用、改善開場，並透過多輪修改讓文章更完整」這類任務。"
  - "想直接閱讀或複製 content-research-writer 的完整 SKILL.md。"
...
協助撰寫高品質內容，會先做研究、補引用、改善開場，並透過多輪修改讓文章更完整。
