---
title: "Excel 試算表 Skill"
description: "建立、編輯與分析 Excel 試算表。"
category: "data"
tags:
...
license: "MIT"
originalName: "anthropics/xlsx"
originalDescription: "Create, edit, and analyze Excel spreadsheets"
activation: "當你需要建立、編輯與分析 Excel 試算表時使用。"
useCases:
  - "需要建立、編輯與分析 Excel 試算表。"
  - "想使用 anthropics/xlsx 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
建立、編輯與分析 Excel 試算表。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `anthropics/xlsx`。
