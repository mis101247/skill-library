---
title: "Winui App Skill"
description: "Bootstrap 與 develop modern WinUI 3 desktop apps 搭配 C# 與 Windows App SDK。"
category: "design"
tags:
...
license: "MIT"
originalName: "openai/winui-app"
originalDescription: "Bootstrap and develop modern WinUI 3 desktop apps with C# and Windows App SDK"
activation: "當你需要Bootstrap 與 develop modern WinUI 3 desktop apps 搭配 C# 與 Windows App SDK時使用。"
useCases:
  - "需要Bootstrap 與 develop modern WinUI 3 desktop apps 搭配 C# 與 Windows App SDK。"
  - "想使用 openai/winui-app 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
Bootstrap 與 develop modern WinUI 3 desktop apps 搭配 C# 與 Windows App SDK。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `openai/winui-app`。
