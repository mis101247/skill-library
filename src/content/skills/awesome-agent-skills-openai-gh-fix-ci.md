---
title: "GH FIX CI 雲端部署 Skill"
description: "Debug 與 fix failing GitHub Actions PR checks 使用 log inspection。"
category: "cloud"
tags:
...
license: "MIT"
originalName: "openai/gh-fix-ci"
originalDescription: "Debug and fix failing GitHub Actions PR checks using log inspection"
activation: "當你需要Debug 與 fix failing GitHub Actions PR checks 使用 log inspection時使用。"
useCases:
  - "需要Debug 與 fix failing GitHub Actions PR checks 使用 log inspection。"
  - "想使用 openai/gh-fix-ci 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
Debug 與 fix failing GitHub Actions PR checks 使用 log inspection。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `openai/gh-fix-ci`。
