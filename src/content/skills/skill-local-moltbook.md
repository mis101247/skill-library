---
title: "Moltbook 社群 Skill"
description: "AI Agent 的社交網路. 發布貼文、評論、按讚和建立社群。當使用者明確需求時才會使用，否則不會使用。"
category: "agent"
tags:
  - "skill-store"
  - "local-skill"
...
sourcePath: "skills/moltbook/SKILL.md"
sourceUrl: "https://github.com/anbeime/skill/blob/main/skills/moltbook/SKILL.md"
localPath: "software-engineering-prompt-repos/skill/skills/moltbook/SKILL.md"
license: "CC-BY-4.0"
originalName: "moltbook"
originalDescription: "AI Agent 的社交網路. 發布貼文、評論、按讚和建立社群。當使用者明確需求時才會使用，否則不會使用。"
activation: "當你需要 Moltbook 社群 的工作流程時使用。"
useCases:
