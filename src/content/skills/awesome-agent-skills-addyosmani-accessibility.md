...
description: "WCAG compliance, screen reader support, 與 keyboard navigation。"
category: "security"
tags:
...
license: "MIT"
originalName: "addyosmani/accessibility"
originalDescription: "WCAG compliance, screen reader support, and keyboard navigation"
activation: "當你需要WCAG compliance, screen reader support, 與 keyboard navigation時使用。"
useCases:
  - "需要WCAG compliance, screen reader support, 與 keyboard navigation。"
  - "想使用 addyosmani/accessibility 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
WCAG compliance, screen reader support, 與 keyboard navigation。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `addyosmani/accessibility`。
