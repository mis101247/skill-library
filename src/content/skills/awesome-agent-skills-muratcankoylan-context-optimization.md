---
title: "Context Optimization Skill"
description: "Apply compaction, masking, 與 caching strategies。"
...
license: "MIT"
originalName: "muratcankoylan/context-optimization"
originalDescription: "Apply compaction, masking, and caching strategies"
activation: "當你需要Apply compaction, masking, 與 caching strategies時使用。"
useCases:
  - "需要Apply compaction, masking, 與 caching strategies。"
  - "想使用 muratcankoylan/context-optimization 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
Apply compaction, masking, 與 caching strategies。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `muratcankoylan/context-optimization`。
