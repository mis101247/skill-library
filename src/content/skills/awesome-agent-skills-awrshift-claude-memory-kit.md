---
title: "Claude Memory KIT Skill"
description: "Persistent memory 搭配 hooks, wiki, 與 daily synthesis 用於 multi-project 工作流。"
category: "agent"
tags:
...
license: "MIT"
originalName: "awrshift/claude-memory-kit"
originalDescription: "Persistent memory with hooks, wiki, and daily synthesis for multi-project workflows"
activation: "當你需要Persistent memory 搭配 hooks, wiki, 與 daily synthesis 用於 multi-project 工作流時使用。"
useCases:
  - "需要Persistent memory 搭配 hooks, wiki, 與 daily synthesis 用於 multi-project 工作流。"
  - "想使用 awrshift/claude-memory-kit 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
Persistent memory 搭配 hooks, wiki, 與 daily synthesis 用於 multi-project 工作流。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `awrshift/claude-memory-kit`。
