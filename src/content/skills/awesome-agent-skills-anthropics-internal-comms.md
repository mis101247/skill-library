...
description: "撰寫 status reports, newsletters, 與 FAQs。"
category: "data"
tags:
...
license: "MIT"
originalName: "anthropics/internal-comms"
originalDescription: "Write status reports, newsletters, and FAQs"
activation: "當你需要撰寫 status reports, newsletters, 與 FAQs時使用。"
useCases:
  - "需要撰寫 status reports, newsletters, 與 FAQs。"
  - "想使用 anthropics/internal-comms 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
撰寫 status reports, newsletters, 與 FAQs。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `anthropics/internal-comms`。
