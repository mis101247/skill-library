---
title: "Security Ownership MAP Skill"
description: "Map people-to-file ownership, compute bus factor, 與 identify risks。"
category: "security"
tags:
...
license: "MIT"
originalName: "openai/security-ownership-map"
originalDescription: "Map people-to-file ownership, compute bus factor, and identify risks"
activation: "當你需要Map people-to-file ownership, compute bus factor, 與 identify risks時使用。"
useCases:
  - "需要Map people-to-file ownership, compute bus factor, 與 identify risks。"
  - "想使用 openai/security-ownership-map 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
Map people-to-file ownership, compute bus factor, 與 identify risks。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `openai/security-ownership-map`。
