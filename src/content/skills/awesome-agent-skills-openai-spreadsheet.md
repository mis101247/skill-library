...
description: "Create, edit, analyze, 與 visualize 試算表 搭配 formulas。"
category: "data"
tags:
...
license: "MIT"
originalName: "openai/spreadsheet"
originalDescription: "Create, edit, analyze, and visualize spreadsheets with formulas"
activation: "當你需要Create, edit, analyze, 與 visualize 試算表 搭配 formulas時使用。"
useCases:
  - "需要Create, edit, analyze, 與 visualize 試算表 搭配 formulas。"
  - "想使用 openai/spreadsheet 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
Create, edit, analyze, 與 visualize 試算表 搭配 formulas。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `openai/spreadsheet`。
