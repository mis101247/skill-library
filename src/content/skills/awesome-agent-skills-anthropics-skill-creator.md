...
description: "指南 用於 creating skills that extend Claude's capabilities。"
category: "design"
tags:
...
license: "MIT"
originalName: "anthropics/skill-creator"
originalDescription: "Guide for creating skills that extend Claude's capabilities"
activation: "當你需要指南 用於 creating skills that extend Claude's capabilities時使用。"
useCases:
  - "需要指南 用於 creating skills that extend Claude's capabilities。"
  - "想使用 anthropics/skill-creator 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
指南 用於 creating skills that extend Claude's capabilities。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `anthropics/skill-creator`。
