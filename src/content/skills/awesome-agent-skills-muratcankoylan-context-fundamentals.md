---
title: "Context Fundamentals Skill"
description: "Understand what context is, why it matters, 與 the anatomy of context in agent systems。"
category: "agent"
tags:
...
license: "MIT"
originalName: "muratcankoylan/context-fundamentals"
originalDescription: "Understand what context is, why it matters, and the anatomy of context in agent systems"
activation: "當你需要Understand what context is, why it matters, 與 the anatomy of context in agent systems時使用。"
useCases:
  - "需要Understand what context is, why it matters, 與 the anatomy of context in agent systems。"
  - "想使用 muratcankoylan/context-fundamentals 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
Understand what context is, why it matters, 與 the anatomy of context in agent systems。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `muratcankoylan/context-fundamentals`。
