---
title: "ASK Questions IF Underspecified 測試 Skill"
description: "Prompt 用於 clarification on ambiguous requirements。"
category: "testing"
tags:
...
license: "MIT"
originalName: "trailofbits/ask-questions-if-underspecified"
originalDescription: "Prompt for clarification on ambiguous requirements"
activation: "當你需要Prompt 用於 clarification on ambiguous requirements時使用。"
useCases:
  - "需要Prompt 用於 clarification on ambiguous requirements。"
  - "想使用 trailofbits/ask-questions-if-underspecified 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
Prompt 用於 clarification on ambiguous requirements。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `trailofbits/ask-questions-if-underspecified`。
