...
description: "Translate app pages 與 layouts into Figma 使用 design system tokens。"
category: "design"
tags:
...
license: "MIT"
originalName: "openai/figma-generate-design"
originalDescription: "Translate app pages and layouts into Figma using design system tokens"
activation: "當你需要Translate app pages 與 layouts into Figma 使用 design system tokens時使用。"
useCases:
  - "需要Translate app pages 與 layouts into Figma 使用 design system tokens。"
  - "想使用 openai/figma-generate-design 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
Translate app pages 與 layouts into Figma 使用 design system tokens。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `openai/figma-generate-design`。
