---
title: "Tailored Resume 產生器 Skill"
description: "Tailored Resume 產生器 相關 Agent Skill，協助處理「Analyzes job descriptions and generates tailored resumes that highlight relevant experience, skills, and achievements to maximize interview chances」這類任務。"
category: "agent"
tags:
  - "skill-store"
  - "local-skill"
...
sourcePath: "skills/tailored-resume-generator/tailored-resume-generator/SKILL.md"
sourceUrl: "https://github.com/anbeime/skill/blob/main/skills/tailored-resume-generator/tailored-resume-generator/SKILL.md"
localPath: "software-engineering-prompt-repos/skill/skills/tailored-resume-generator/tailored-resume-generator/SKILL.md"
license: "CC-BY-4.0"
originalName: "tailored-resume-generator"
originalDescription: "Tailored Resume 產生器 相關 Agent Skill，協助處理「Analyzes job descriptions and generates tailored resumes that highlight relevant experience, skills, and achievements to maximize interview chances」這類任務。"
activation: "當你需要 Tailored Resume 產生器 的工作流程時使用。"
useCases:
  - "需要處理「Tailored Resume 產生器 相關 Agent Skill，協助處理「Analyzes job descriptions and generates tailored resumes that highlight relevant experience, skills, and achievements to maximize interview chances」這類任務」這類任務。"
  - "想直接閱讀或複製 tailored-resume-generator 的完整 SKILL.md。"
...
files:
  - "skills/tailored-resume-generator/tailored-resume-generator/SKILL.md"
cautions:
...
Tailored Resume 產生器 相關 Agent Skill，協助處理「Analyzes job descriptions and generates tailored resumes that highlight relevant experience, skills, and achievements to maximize interview chances」這類任務。
