---
title: "Slides Skill"
description: "建立 and edit .pptx presentation decks 搭配 PptxGenJS。"
category: "docs"
tags:
...
license: "MIT"
originalName: "openai/slides"
originalDescription: "Create and edit .pptx presentation decks with PptxGenJS"
activation: "當你需要建立 and edit .pptx presentation decks 搭配 PptxGenJS時使用。"
useCases:
  - "需要建立 and edit .pptx presentation decks 搭配 PptxGenJS。"
  - "想使用 openai/slides 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
建立 and edit .pptx presentation decks 搭配 PptxGenJS。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `openai/slides`。
