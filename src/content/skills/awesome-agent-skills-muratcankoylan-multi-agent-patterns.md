...
description: "Master orchestrator, peer-to-peer, 與 hierarchical multi-agent architectures。"
category: "agent"
tags:
...
license: "MIT"
originalName: "muratcankoylan/multi-agent-patterns"
originalDescription: "Master orchestrator, peer-to-peer, and hierarchical multi-agent architectures"
activation: "當你需要Master orchestrator, peer-to-peer, 與 hierarchical multi-agent architectures時使用。"
useCases:
  - "需要Master orchestrator, peer-to-peer, 與 hierarchical multi-agent architectures。"
  - "想使用 muratcankoylan/multi-agent-patterns 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
Master orchestrator, peer-to-peer, 與 hierarchical multi-agent architectures。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `muratcankoylan/multi-agent-patterns`。
