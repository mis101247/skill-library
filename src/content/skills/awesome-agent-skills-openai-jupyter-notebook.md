...
description: "建立 clean, reproducible Jupyter notebooks 用於 experiments 與 tutorials。"
category: "data"
tags:
...
license: "MIT"
originalName: "openai/jupyter-notebook"
originalDescription: "Create clean, reproducible Jupyter notebooks for experiments and tutorials"
activation: "當你需要建立 clean, reproducible Jupyter notebooks 用於 experiments 與 tutorials時使用。"
useCases:
  - "需要建立 clean, reproducible Jupyter notebooks 用於 experiments 與 tutorials。"
  - "想使用 openai/jupyter-notebook 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
建立 clean, reproducible Jupyter notebooks 用於 experiments 與 tutorials。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `openai/jupyter-notebook`。
