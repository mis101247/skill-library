---
title: "SPEC TO CODE Compliance Skill"
description: "Specification-to-code compliance checker 用於 blockchain audits。"
category: "security"
tags:
...
license: "MIT"
originalName: "trailofbits/spec-to-code-compliance"
originalDescription: "Specification-to-code compliance checker for blockchain audits"
activation: "當你需要Specification-to-code compliance checker 用於 blockchain audits時使用。"
useCases:
  - "需要Specification-to-code compliance checker 用於 blockchain audits。"
  - "想使用 trailofbits/spec-to-code-compliance 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
Specification-to-code compliance checker 用於 blockchain audits。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `trailofbits/spec-to-code-compliance`。
