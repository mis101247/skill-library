---
title: "PDF Skill"
description: "Read, create, 與 review PDFs 搭配 layout 與 visual formatting integrity。"
category: "docs"
tags:
...
license: "MIT"
originalName: "openai/pdf"
originalDescription: "Read, create, and review PDFs with layout and visual formatting integrity"
activation: "當你需要Read, create, 與 review PDFs 搭配 layout 與 visual formatting integrity時使用。"
useCases:
  - "需要Read, create, 與 review PDFs 搭配 layout 與 visual formatting integrity。"
  - "想使用 openai/pdf 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
Read, create, 與 review PDFs 搭配 layout 與 visual formatting integrity。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `openai/pdf`。
