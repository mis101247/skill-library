---
title: "Web App Testing Skill"
description: "測試 local Web 應用程式 使用 Playwright。"
category: "testing"
tags:
...
license: "MIT"
originalName: "anthropics/webapp-testing"
originalDescription: "Test local web applications using Playwright"
activation: "當你需要測試 local Web 應用程式 使用 Playwright時使用。"
useCases:
  - "需要測試 local Web 應用程式 使用 Playwright。"
  - "想使用 anthropics/webapp-testing 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
測試 local Web 應用程式 使用 Playwright。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `anthropics/webapp-testing`。
