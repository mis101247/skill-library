---
title: "Context Compression 身分驗證 Skill"
description: "設計 and evaluate compression strategies 用於 long-running sessions。"
category: "auth"
tags:
...
license: "MIT"
originalName: "muratcankoylan/context-compression"
originalDescription: "Design and evaluate compression strategies for long-running sessions"
activation: "當你需要設計 and evaluate compression strategies 用於 long-running sessions時使用。"
useCases:
  - "需要設計 and evaluate compression strategies 用於 long-running sessions。"
  - "想使用 muratcankoylan/context-compression 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
設計 and evaluate compression strategies 用於 long-running sessions。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `muratcankoylan/context-compression`。
