---
title: "Agent Reach Skill"
description: "Multi-platform search CLI 用於 17 sites including Chinese platforms。"
category: "agent"
tags:
...
license: "MIT"
originalName: "Panniantong/Agent-Reach"
originalDescription: "Multi-platform search CLI for 17 sites including Chinese platforms"
activation: "當你需要Multi-platform search CLI 用於 17 sites including Chinese platforms時使用。"
useCases:
  - "需要Multi-platform search CLI 用於 17 sites including Chinese platforms。"
  - "想使用 Panniantong/Agent-Reach 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
Multi-platform search CLI 用於 17 sites including Chinese platforms。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `Panniantong/Agent-Reach`。
