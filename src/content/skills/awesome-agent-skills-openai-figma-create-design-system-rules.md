...
description: "Rules 用於 implementing Figma designs 使用 the Figma MCP server。"
category: "design"
tags:
...
license: "MIT"
originalName: "openai/figma-create-design-system-rules"
originalDescription: "Rules for implementing Figma designs using the Figma MCP server"
activation: "當你需要Rules 用於 implementing Figma designs 使用 the Figma MCP server時使用。"
useCases:
  - "需要Rules 用於 implementing Figma designs 使用 the Figma MCP server。"
  - "想使用 openai/figma-create-design-system-rules 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
Rules 用於 implementing Figma designs 使用 the Figma MCP server。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `openai/figma-create-design-system-rules`。
