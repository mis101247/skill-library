...
description: "Basic template 用於 creating new skills。"
category: "agent"
tags:
...
license: "MIT"
originalName: "anthropics/template"
originalDescription: "Basic template for creating new skills"
activation: "當你需要Basic template 用於 creating new skills時使用。"
useCases:
  - "需要Basic template 用於 creating new skills。"
  - "想使用 anthropics/template 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
Basic template 用於 creating new skills。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `anthropics/template`。
