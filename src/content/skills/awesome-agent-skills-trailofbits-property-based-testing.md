---
title: "Property Based Testing Skill"
description: "Property-based testing 用於 multiple languages 與 smart contracts。"
category: "testing"
tags:
...
license: "MIT"
originalName: "trailofbits/property-based-testing"
originalDescription: "Property-based testing for multiple languages and smart contracts"
activation: "當你需要Property-based testing 用於 multiple languages 與 smart contracts時使用。"
useCases:
  - "需要Property-based testing 用於 multiple languages 與 smart contracts。"
  - "想使用 trailofbits/property-based-testing 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
Property-based testing 用於 multiple languages 與 smart contracts。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `trailofbits/property-based-testing`。
