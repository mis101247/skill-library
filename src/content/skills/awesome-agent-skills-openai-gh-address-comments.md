---
title: "GH Address Comments Skill"
description: "Address review 與 issue comments on open GitHub PRs via CLI。"
category: "agent"
tags:
...
license: "MIT"
originalName: "openai/gh-address-comments"
originalDescription: "Address review and issue comments on open GitHub PRs via CLI"
activation: "當你需要Address review 與 issue comments on open GitHub PRs via CLI時使用。"
useCases:
  - "需要Address review 與 issue comments on open GitHub PRs via CLI。"
  - "想使用 openai/gh-address-comments 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
Address review 與 issue comments on open GitHub PRs via CLI。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `openai/gh-address-comments`。
