---
title: "Claude IN Chrome Troubleshooting Skill"
description: "Diagnose 與 fix Claude in Chrome MCP extension connectivity issues。"
category: "security"
tags:
...
license: "MIT"
originalName: "trailofbits/claude-in-chrome-troubleshooting"
originalDescription: "Diagnose and fix Claude in Chrome MCP extension connectivity issues"
activation: "當你需要Diagnose 與 fix Claude in Chrome MCP extension connectivity issues時使用。"
useCases:
  - "需要Diagnose 與 fix Claude in Chrome MCP extension connectivity issues。"
  - "想使用 trailofbits/claude-in-chrome-troubleshooting 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
Diagnose 與 fix Claude in Chrome MCP extension connectivity issues。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `trailofbits/claude-in-chrome-troubleshooting`。
