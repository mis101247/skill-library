...
description: "Static analysis toolkit 搭配 CodeQL, Semgrep, 與 SARIF。"
category: "security"
tags:
...
license: "MIT"
originalName: "trailofbits/static-analysis"
originalDescription: "Static analysis toolkit with CodeQL, Semgrep, and SARIF"
activation: "當你需要Static analysis toolkit 搭配 CodeQL, Semgrep, 與 SARIF時使用。"
useCases:
  - "需要Static analysis toolkit 搭配 CodeQL, Semgrep, 與 SARIF。"
  - "想使用 trailofbits/static-analysis 這類已整理好的 Agent Skill，而不是從零撰寫 prompt。"
...
Static analysis toolkit 搭配 CodeQL, Semgrep, 與 SARIF。這筆資料來自 `awesome-agent-skills` 的索引清單，原始專案是 `trailofbits/static-analysis`。
